    ...
    <>
      <div className="mb-20">
        <div className="max-w-[95rem] mx-auto w-full">
          ...
          <ProjectTab />
          <div className="relative top-15 left-9 flex justify-end items-center p-4">
            <SeeProjectsButton/>
          </div>
        </div>
      </div>
...
const SeeProjectsButton = () => {
  ...
  return (
    <motion.div variants={itemVariants}>
      <motion.button
        className="group relative inline-flex items-center justify-center font-semibold rounded-full overflow-hidden shadow-md px-6 py-2 cursor-pointer"
        whileHover={{
          y: -2,
      ...
      >
        ...
        {/* Text */}
        <span className="relative z-10 mr-2 bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent font-semibold">
          See all my projects
        </span>

        {/* Arrow icon */}
        <motion.svg
          className="relative z-10 w-4 h-4 text-orange-400"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          whileHover={{
