        ...
        {isOpen && (
          ...
          >
            <div className="bg-card rounded-2xl shadow-2xl border border-border flex flex-col overflow-hidden h-full">
              {/* Header */}
              <motion.div 
                className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 p-4 flex items-center justify-between"
                layoutId="chatHeader"
              >
                        ...
                        <div className={`flex items-start space-x-2 max-w-[80%] ${
                          ...
                          <motion.div
                            className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                              message.sender === 'user' ? 'bg-primary' : 'bg-gradient-to-r from-purple-500 to-pink-500'
                            }`}
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
